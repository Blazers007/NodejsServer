...
(function(root) {
  root.BmobSocketIo = root.BmobSocketIo || {};
  /**
   * åŒ…å«äº†æ‰€æœ‰BmobSocketIoçš„apiå’Œå‡½æ•°
   *
   * åŒ…å«äº†æ‰€æœ‰BmobSocketIoçš„apiå’Œå‡½æ•°
   */
    ...
    xdr.onload = function() {
      ...
      try {
        response = JSON.parse(xdr.responseText);
            //ajaxèŽ·å–ip and port, then set this value
  ...
  /**
   * åˆå§‹åŒ–æ—¶éœ€è¦è°ƒç”¨è¿™ä¸ªå‡½æ•°ã€‚å¯ä»¥ä»ŽBmobSocketIoä¸­èŽ·å–æ‰€éœ€çš„key
   * 
   * @param {String} applicationId ä½ çš„ Application ID.
   * @param {String} applicationKey ä½ çš„ restful api Key.
   * @param {String} masterKey (optional) ä½ çš„ BmobSocketIo Master Key. 
   */
   ...
   */
   BmobSocketIo._initialize = function(applicationId) {
    ...
    //ç›‘å¬æœåŠ¡å™¨çš„å“åº”
     ...
     //è¿žæŽ¥ä¸Šsocket.ioæœåŠ¡å™¨åŽè§¦å‘çš„äº‹ä»¶
...
//ç›‘å¬æœåŠ¡å™¨è¿”å›žçš„æ›´æ–°æ•°æ®è¡¨çš„æ•°æ®ï¼Œéœ€è¦ç”¨æˆ·é‡å†™
...
//åˆå§‹è¿žæŽ¥socket.ioæœåŠ¡å™¨åŽï¼Œéœ€è¦ç›‘å¬çš„äº‹ä»¶éƒ½å†™åœ¨è¿™ä¸ªå‡½æ•°å†…ï¼Œ
//æ³¨æ„ï¼Œå¿…é¡»è¦æŠŠç›‘å¬çš„æ•°æ®å†™åœ¨è¿™ä¸ªå‡½æ•°å†…ï¼Œ
//å½“æµè§ˆå™¨å› æ„å¤–æ–­ç½‘åŽï¼ŒæœåŠ¡å™¨ä¸Šçš„è®¢é˜…äº‹ä»¶ä¼šå–æ¶ˆï¼Œjsè„šæœ¬ä¼šé‡æ–°è¿žæŽ¥æœåŠ¡å™¨ï¼Œå†™åœ¨è¿™ä¸ªå‡½æ•°å†…çš„è®¢é˜…äº‹ä»¶ä¼šé‡æ–°åœ¨æœåŠ¡å™¨ä¸Šè®¢é˜…
